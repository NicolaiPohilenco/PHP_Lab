...
$file = fopen("../lab5-6_PohilencoNicolai/file.txt", "a") or die("Error opening for adding data!");
if (!$file) {
    echo ("No file was found to add data!");
} else {
    // Добавьте в файл с помощью функции fwrite() еще 3 записи
    fwrite($file, "6. Jessica Jons, 1997, 8753983985847\n");
    fwrite($file, "7. Matew Merdok, 1956, 9087385610392\n");
    fwrite($file, "8. Tia Harribel, 1999, 4627891047984\n");
}
fclose($file);
//Открываем файл для чтения из него
$file = fopen("../lab5-6_PohilencoNicolai/file.txt", "r") or die("Error opening a file for reading!");
if (!$file) {
